    ...
    subs: [
      {
        icon: "simple-icon-graduation",
        label: "menu.classes",
        to: "/app/classes/classes",
      },
      {
        icon: "simple-icon-book-open",
        label: "menu.subjects",
        to: "/app/classes/subjects",
      },
      {
        icon: "simple-icon-note",
        label: "menu.marks",
        to: "/app/classes/marks",
      },
      {
        icon: "simple-icon-organization",
        label: "menu.exams",
        to: "/app/classes/exams",
      },
      {
        icon: "simple-icon-calendar",
        label: "menu.time-table",
        to: "/app/classes/time-table",
      },
    ],
  },
  {
    ...
    label: "menu.attendence",
    to: "/app/attendence",
    subs: [
      {
        icon: "simple-icon-check",
        label: "menu.students-attendence",
        to: "/app/attendence/students-attendence",
      },
      {
        icon: "simple-icon-check",
        label: "menu.teachers-attendence",
        to: "/app/attendence/teachers-attendence",
      },
    ],
  },
  {
